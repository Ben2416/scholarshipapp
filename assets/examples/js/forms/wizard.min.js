...
!function(document,window,$){
	...
	function(){
		...
		$("#exampleBillingForm").formValidation({
			...
			fields:{
				...
				cvv:{validators:{notEmpty:{message:"The CVV number is required"}}}}
		});
	...
	function(){
		...
		defaults,
		{
			...
			validator:function(){
				...
				return isValidStep===!1||null===isValidStep?!1:!0},
				onFinish:function(){alert('it is over')},
				buttonsAppendTo:".panel-body"
		});
		...
		defaults,
		{
			...
			templates:{
				buttons:function(){
					...
					html='<div class="btn-group btn-group-sm btn-group-flat"><a class="btn btn-default" href="#'+this.id+'" data-wizard="back" role="button">'
					+options.buttonLabels.back+'</a><a class="btn btn-success pull-right" href="#'
					+this.id+'" data-wizard="finish" role="button">'+options.buttonLabels.finish+'</a><a class="btn btn-default pull-right" href="#'+this.id
					+'" data-wizard="next" role="button">'+options.buttonLabels.next+"</a></div>";
					return html
				}
			},buttonLabels:{
	...
	function(){
		...
		defaults,{
			...
			onAfterChange:function(prev,step){
				...
				this.$progressbar.css({width:percent+"%"}).find(".sr-only").text(current+"/"+total)},
				buttonsAppendTo:".panel-body"
		});
	...
	function(){
		var defaults=$.components.getDefaults("wizard"),
		options=$.extend(!0,{},defaults,{step:'.panel-title[data-toggle="collapse"]',
